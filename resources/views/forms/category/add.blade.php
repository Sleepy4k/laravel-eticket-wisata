                        ...
                        <div class="table-responsive p-0">
                            <div class="col-lg-4 col-md-8 col-12 mx-auto">
                                <div class="card z-index-0 fadeIn3 fadeInBottom">
                                    <form action="{{ route('category.store') }}" method="post" class="text-start m-3">
                                        @csrf
                                        ...
                                        <div class="input-group input-group-outline mb-3">
                                            ...
                                            <input name="permission" id="permission" type="text" class="form-control" value="{{ old('permission') }}" required autofocus>
                                        </div>
