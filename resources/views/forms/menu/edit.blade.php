                        ...
                        <div class="table-responsive p-0">
                            <div class="col-lg-4 col-md-8 col-12 mx-auto">
                                <div class="card z-index-0 fadeIn3 fadeInBottom">
                                    <form action="{{ route('menu.update', $data[2]) }}" method="post" class="text-start m-3">
                                        @csrf
                                        <div class="input-group input-group-outline my-3 is-filled">
                                            <label class="form-label">
                                                Nama Menu
                                            </label>
                                            <input name="name" id="name" type="text" class="form-control" value="{{ old('name', $menu->name) }}" required autofocus>
                                        </div>
                                        ...
                                        <div class="input-group input-group-outline mb-3 is-filled">
                                            ...
                                            <input name="icon" id="icon" type="text" class="form-control" value="{{ old('icon', $menu->icon) }}" required autofocus>
                                        </div>
                                        ...
                                        <div class="input-group input-group-outline mb-3">
                                            ...
                                            <select id="page_id" name="page_id" class="form-select" style="text-align: center;">
                                                @foreach ($pages as $page)
                                                    <option value="{{ $page->id }}" @if($menu->page_id == $page->id) selected @endif>
                                                        {{ $page->name }}
                                                    </option>
                                                @endforeach
                                            </select>
